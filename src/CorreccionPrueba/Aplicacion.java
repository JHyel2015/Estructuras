...
public class Aplicacion {
	...
	private Profesor prof1,prof2,prof3,prof4,prof5,profesores[];
	private Alumno alum1,alum2,alum3,alum4,alum5,alumnos[];
	...
	public Aplicacion() {
		...
		alumnos = new Alumno[]{alum1,alum2,alum3,alum4,alum5};
		...
		profesores = new Profesor[]{prof1,prof2,prof3,prof4,prof5};
